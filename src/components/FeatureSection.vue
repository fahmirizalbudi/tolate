...
<template>
  <section id="feature">
    <div class="feature__info">
      <h2 class="feature__title">Everything you need to stay organized</h2>
      <span class="feature__description">Tolate provides all the essential features to manage your day-to-day, without
        the clutter.</span>
    </div>
